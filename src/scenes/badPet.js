...
const BadPet = () => {
    ...
    const phrases = ["I'm hungry. Feed me", "Hey! I mean meow.", "Woof woof", "Feed me please", "I hunger for human food", "I'm bored, feed me. I want to feel something", "Hi friend!", "Woo hoo!", "Meow!", "Haven't seen u in a while!", "Tubular!", "Wowza!", "Fantastic!", "Stop feeding me! I've eaten enough", "Please stop"]
    return (
        <SafeAreaView>
